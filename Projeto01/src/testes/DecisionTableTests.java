...
class DecisionTableTests {
	...
	void test3() throws ParseException, InvocationTargetException {
		Client c1 = new Client("Mano Max", this.getDateWithMonthSetFromToday(-1), "GO"); // Client (name, inclusion date, estate)		
	...
	void test5() throws ParseException, InvocationTargetException {
		...
		Client c1 = new Client("Mano Max", this.getDateWithMonthSetFromToday(-2), "AM"); // Client (name, inclusion date, estate)		
